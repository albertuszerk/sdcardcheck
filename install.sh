#!/bin/bash
USER_LANG="${1:-de}" # Nimmt Parameter 1 (z.B. 'en'). Standard ist 'de'.
echo "Installiere X-Capacity & Speed Validator (sdcardcheck) in Sprache: $USER_LANG..."
...
# Desktop-Starter anlegen
cat << 'EOF' > ~/.local/share/applications/sdcardcheck.desktop
[Desktop Entry]
Name=sdcardcheck
Comment=X-Capacity & Speed Validator for sd cards v1.0
...
echo "Installation abgeschlossen! Du findest 'sdcardcheck' nun im Startmenue."
